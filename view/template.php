...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Passez un bon temps avec la famille en regardant les film ou les series. Faitez vos rechercher du film par acteur ou réalisateur preféré">
...
<!-- --------------------------FOOTER------------------------------ -->
<footer>
    <div class="block-footer-one" id="shadow">
        <p>SUIVEZ-NOUS</p>
    ...
    <div class="footer-info">
        <p>Contact | </p><p>©TopFilm |</p> 
        <p>Retrouvez tous les horaires et infos de votre cinéma sur le  
            numéro TopFilm:  0891 891 881(0,90€/minute)</p> 
